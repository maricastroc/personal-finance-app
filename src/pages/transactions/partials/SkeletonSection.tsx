...
export const SkeletonSection = () => {
  return (
    <section
      className="mt-8 flex flex-col px-5 py-6 rounded-xl md:p-10 animate-pulse"
      style={{
    ...
    >
      ...
      <div className="flex flex-col md:grid md:grid-cols-[1fr,2fr] lg:flex lg:flex-row lg:justify-between w-full gap-2 pb-6 md:gap-6">
        ...
        <div className="flex justify-between gap-3 items-center lg:w-full xl:max-w-[28rem]">
          <div className="h-10 bg-surface-600 rounded-md flex-grow"></div>
          <div className="md:hidden flex gap-2">
            <div className="h-10 w-10 bg-surface-600 rounded-md"></div>
            <div className="h-10 w-10 bg-surface-600 rounded-md"></div>
          </div>
        </div>
        ...
        <div className="hidden md:flex w-full gap-5 items-center md:justify-end">
          ...
          <div className="md:min-w-[11rem] md:max-w-[13rem] lg:max-w-[16rem] w-full flex items-center gap-2">
            <div className="h-4 bg-surface-600 rounded w-12"></div>
            <div className="h-10 bg-surface-600 rounded-md flex-grow"></div>
          </div>
        </div>
      </div>
              ...
              <tr key={rowIndex} className="border-t">
                ...
                <td className="px-4 py-3 text-left">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-surface-600 rounded-full"></div>
                    <div className="flex flex-col gap-2">
                      <div className="h-4 bg-surface-600 rounded w-24"></div>
                ...
                <td className="px-4 py-3 text-right">
                  <div className="h-4 bg-surface-600 rounded w-12 ml-auto"></div>
                </td>

                {/* Actions Column */}
                <td className="px-4 py-3 text-center">
                  <div className="flex justify-center gap-2">
                    <div className="h-8 w-8 bg-surface-600 rounded"></div>
                    <div className="h-8 w-8 bg-surface-600 rounded"></div>
                  </div>
                </td>
              </tr>
      ...
      <div className="flex items-center justify-between gap-2 mt-6">
        <div className="flex items-center gap-2">
          {[...Array(4)].map((_, index) => (
            <div key={index} className="h-8 w-8 bg-surface-600 rounded"></div>
          ))}
        </div>
        <div className="h-4 bg-surface-600 rounded w-20"></div>
      </div>
